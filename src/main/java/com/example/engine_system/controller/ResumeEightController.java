...
public class ResumeEightController {
    ...
    @PutMapping("/updateResumeEight")
    public int updateResumeEight(@ModelAttribute("resume") List<ResumeEight> resume) {
        return ResumeEightService.updateResumeEight(resume);
    }
